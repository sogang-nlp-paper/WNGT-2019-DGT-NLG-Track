...
#nohup python train.py -data data/rotowire/demo -encoder_type transformer -decoder_type transformer -heads 6 -rnn_size 600 -src_word_vec_size 600 -tgt_word_vec_size 600 -feat_merge mlp -feat_vec_size 600 -copy_attn -reuse_copy_attn -early_stopping 3 -batch_size 64 -truncated_decoder 100 -optim adam -learning_rate 1 --decay_method noam -param_init_glorot -train_steps 200000 -gpu_rank 0 -proc_name hwii:$1 -save_model models/$1/model &> models/$1.txt &
