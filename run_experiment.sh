...
# review_net
#nohup python train.py -data data/rotowire/demo -encoder_type entity_mean -rnn_size 600 -src_word_vec_size 600 -tgt_word_vec_size 600 -feat_merge mlp -feat_vec_size 600 -early_stopping 3 -batch_size 64 -truncated_decoder 100 -optim adam -learning_rate 0.001 -gpu_rank 0 -proc_name hwii:$1 -save_model models/$1/model -review_steps 32 -review_type input -review_net > models/$1.txt &

# rnn_encoder
#nohup python train.py -data data/rotowire/demo -src_word_vec_size 600 -tgt_word_vec_size 600 -feat_merge mlp -feat_vec_size 600 -encoder_type rnn  -rnn_size 600 -copy_attn -reuse_copy_attn -early_stopping 3 -batch_size 64 -truncated_decoder 100 -optim sgd -gpu_rank 0 -proc_name hwii:$1 -save_model models/$1/model > models/$1.txt &

# review_copy
nohup python train.py -data data/rotowire/demo -encoder_type entity_mean -rnn_size 600 -src_word_vec_size 600 -tgt_word_vec_size 600 -feat_merge mlp -feat_vec_size 600 -early_stopping 3 -batch_size 64 -truncated_decoder 100 -optim adam -learning_rate 0.001 -gpu_rank 0 -proc_name hwii:$1 -save_model models/$1/model -review_steps 8 -review_type input -review_net -copy_attn > models/$1.txt &
