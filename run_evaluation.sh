...
nvidia-docker run -ti --rm -v /home/hwijeen/WNGT2019/data:/home/WNGT2019/data -v /home/hwijeen/WNGT2019/models/:/home/WNGT2019/models hwijeen:1.0 th tools/extractor.lua -gpuid 1 -datafile data/rotowire/roto-ie.h5 -preddata models/$1/pred.h5 -dict_pfx data/rotowire/roto-ie -just_eval |tee models/$1/rg_result.txt
